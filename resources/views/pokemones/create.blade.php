        ...
        <div class="max-w-md mx-auto">
          <div class="flex items-center space-x-5">
            ...
            <div class="block pl-2 font-semibold text-xl self-start text-gray-700">
              <h2 class="leading-relaxed">Agrega un Pokemon</h2>
              <p class="text-sm text-gray-500 font-normal leading-relaxed">Agrega un pokemon aqui.</p>
            </div>
          </div>
            ...
            <div class="divide-y divide-gray-200">
                <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                  <div class="flex flex-col">
                    ...
                    <input type="text" name="nombrePokemon" id="nombre_input" required value="{{ old('nombre') }}" class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="">
                  </div>
                  <div class="flex flex-col">
                    <label class="leading-loose">Numero del Pokemon</label>
                    <input type="text" name="Numero" id="numero_input" required class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="">
                  </div>
                  <div class="flex flex-col">
                    <label class="leading-loose">Habilidad</label>
                    <input type="text" name="habilidadPokemon" id="habilidad_input" required class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="">
                  </div>
                  <div class="flex flex-col">
                    <label class="leading-loose">Peso</label>
                    <input type="text" name="pesoPokemon" id="peso_input" required class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="">
                  </div>
                  <div class="flex flex-col">
                    <label class="leading-loose">Altura</label>
                    <input type="text" name="alturaPokemon" id="altura_input" required class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="">
                  </div>
                    ...
                    <div class="flex flex-col">
                        ...
                        <select name="debilidadPokemon" id="debilidad"  required class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600">
                          ...
                          @foreach ($debilidades as $debilidad)
                              <option value="{{ $debilidad->id }}">{{ $debilidad->nombre}}</option>
                          @endforeach
                      </select>
                    </div>
                  </div>
                  <div class="flex flex-col">
                    ...
                    <input type="text" name="psPokemon" id="ps_input" class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="">
                  </div>
                  <div class="flex flex-col">
                    <label class="leading-loose">Ataque</label>
                    <input type="text" name="ataquePokemon" id="ataque_input" class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="">
                  </div>
                  <div class="flex flex-col">
                    <label class="leading-loose">Defensa</label>
                    <input type="text" name="defensaPokemon" id="defensa_input" class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="">
                  </div>
                  <div class="flex flex-col">
                    <label class="leading-loose">Velocidad</label>
                    <input type="text" name="velocidadPokemon" id="velocidad_input" class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="">
                  </div>
                  <div class="flex flex-col">
